...
class ApplicationController < ActionController::Base
  ...
  include ActionRescue if Rails.env.production?

  # Requires upgrading this https://github.com/ThoughtWorksStudios/oauth2_provider to a gem
