...
module ApplicationHelper
  ...
  #FIXME this has a different behaviour on Ruby 1.9 when button_content(name, HASH)
  ...
  def version
    File.readlines(Rails.root.join("../vm/admin/admin_version.txt.vm")).first
  end
  ...
  def content_wrapper_tag(options={})
    return "<div class=\"content_wrapper_outer\"><div class=\"content_wrapper_inner\">".html_safe
  end
